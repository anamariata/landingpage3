...
export function TopNavDoctor() {
  ...
  return (
    <header className="hidden md:block sticky top-0 z-30 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
